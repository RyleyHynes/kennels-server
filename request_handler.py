...
from views import (get_all_animals, get_single_animal, create_animal, delete_animal, update_animal, get_animal_by_location, get_animals_by_status, get_all_customers,get_single_customer, create_customer, delete_customer, update_customer, get_customers_by_email, get_all_employees, get_single_employee, create_employee, delete_employee, update_employee, get_employees_by_location, get_all_locations, get_single_location, create_location, delete_location, update_location)
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if '?' not in self.path:
            ...
            # query animals by status => related to db_cursor execute section in animal_request
    ...
    def do_POST(self):
        ...
        # Add a new animal, location,employee, and customer to the list. Don't worry about
        if resource == "animals":

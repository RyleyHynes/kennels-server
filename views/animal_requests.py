...
def get_all_animals():
    """This function queries the database for all animals,
    converts each row into an Animal Instance, converts the list to JSON, and
    ...
    with sqlite3.connect("./kennel.sqlite3") as conn:
        ...
        for row in dataset:
            ...
            # parameters defined in the Animal class above
...
def get_animal_by_location(location):
    """This function retrieves animals by location_id"""
    with sqlite3.connect("./kennel.sqlite3") as conn:
        conn.row_factory = sqlite3.Row
        db_cursor = conn.cursor()
